...
class DistressLogger:
    ...
    def log_frame(
        ...
        backend_payload = {
                ...
                "global_distress": ci.global_distress,

                "pain_index": ci.pain_index,
                "fear_index": ci.fear_index,
                "fatigue_index": ci.fatigue_index,
                "agitation_index": ci.agitation_index,
                "tension_index": ci.tension_index,
                "respiratory_index": ci.respiratory_index,
                ...
                "gaze_variance": (
                    gaze_data.get("gaze_variance", 0.0)
                    if gaze_data else 0.0
                ),

                "fixation_duration": (
                    gaze_data.get("fixation_duration", 0.0)
                    if gaze_data else 0.0
                ),
                ...
                "eye_contact_ratio": (
                    gaze_data.get("eye_contact_ratio", 0.0)
                    if gaze_data else 0.0
                ),
                ...
                "face_confidence": confidence.overall,
            }
